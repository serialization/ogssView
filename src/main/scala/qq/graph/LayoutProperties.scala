...
extends PropertyOwner {
  val c1: Property[Float] = new Property(this, "edge force scale factor (c1)", 1.0f)
  val c3: Property[Float] = new Property(this, "node-node repulsion force scale factor (c3)", 1.0f)
